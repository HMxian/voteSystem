				...
				<div class="tpl-header">
					<div class="tpl-header-fluid">
						...
						<div class="tpl-button text">
							<a href=""><i class="fa fa-user"></i> 管理员们</a>
						</div>
				...
				<div class="tpl-content">
					<div class="tpl-pannel clearfix">
						<div class="tpl-h-title">
							<a href="user_add.html" class="layui-btn layui-btn-sm layui-btn-normal">维护列表</a>
						</div>
						<table class="layui-table" lay-even="" lay-skin="row">
							...
							<tbody>
								<c:forEach items="${voInfors}" var="v">
								<tr>
									<td><a class="returnlist-a"href="VoteServlet?flag=checkvote&vid=${v.voteId}&voteType=${v.voteType}">${v.voteName}</a></td>
									<td>启用</td>
					
									<td>2018-09-07 21:43:51</td>
									<td class="item-a" data-id="14"><a href="VoteServlet?flag=maintenance&vid=${v.voteId}&gopage=${nowpage}">维护</a><a href="VoteServlet?flag=maintenanceDelet&vid=${v.voteId}&gopage=${nowpage}">删除</a></td>
											...
											<center >
		<a href="PageServlet?flag=maintenancepage&gopage=${nowpage-1}">上一页</a>&nbsp;&nbsp;${nowpage}/${totalpage}&nbsp;
		<a href="PageServlet?flag=maintenancepage&gopage=${nowpage+1}">下一页</a>
	</center>
					</div>
				</div>
				<!--配色方案-->
