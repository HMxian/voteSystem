					...
					<div class="tpl-header-fluid">
						...
						<div class="tpl-userbar">
							<ul>
								...
								<li><a href="login.jsp" class="logout"><i class="fa fa-power-off"></i>退出登录</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="tpl-content">
					<div class="tpl-pannel">
						<div class="tpl-h-title">
							<a href="" class="layui-btn layui-btn-sm layui-btn-normal">投票列表</a>
						</div>
				...
				<form action="VoteServlet?flag=votesearch" method="post" target="myframe">
					...
					<input type="submit" value="搜索">
						...
						<table class="layui-table" lay-even="" lay-skin="row">
							...
							<center >
		<a href="PageServlet?flag=page&gopage=${nowpage-1}">上一页</a>&nbsp;&nbsp;${nowpage}/${totalpage}&nbsp;
		<a href="PageServlet?flag=page&gopage=${nowpage+1}">下一页</a>
	</center>
					</div>
				</div>
				<!--配色方案-->
